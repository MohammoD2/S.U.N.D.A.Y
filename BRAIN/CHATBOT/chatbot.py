...
model = GPT2LMHeadModel.from_pretrained(r'D:\Work file\S.U.N.D.A.Y\gpt3-finetuned-chatbot')
tokenizer = GPT2Tokenizer.from_pretrained(r'D:\Work file\S.U.N.D.A.Y\gpt3-finetuned-chatbot')
